...
//           $ionicPopup.alert({title:"Hey!", template: messages.nice.fatty[rNum] }); }, 10000);
//
//         }
...
//           $ionicPopup.alert({title:"Hey!", template: messages.nice.meh[rNum] }); }, 10000);
//       }
//       else if(pInt > 49 && pInt < 75){
//         setInterval(function(){
//           var rNum = Math.floor(Math.random()*3);
//           // alert(messages.nice.healthy[rNum]); }, 60000);
//           $ionicPopup.alert({title:"Hey!", template: messages.nice.healthy[rNum] }); }, 10000);
//       }
//       else {
//         setInterval(function(){
//           var rNum = Math.floor(Math.random()*3);
//           // alert(messages.nice.fit[rNum]); }, 60000);
//           $ionicPopup.alert({title:"Hey!", template: messages.nice.fit[rNum] }); }, 10000);
//       }
//     };
//
